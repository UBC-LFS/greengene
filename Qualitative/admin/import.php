...
if ($formaction == "import") {
    ...
    //    $classList = ['johnDoe', 'benDoe', 'janDoe'];
...
$table->writeRow('Course Section', "<input requiredtype=\"text\" name=\"section\" maxlength=\"4\" placeholder=\"002\">");
$table->writeRow('Year', "<input required type=\"number\" name=\"year\" maxlength=\"4\" placeholder=\"2020\">");
