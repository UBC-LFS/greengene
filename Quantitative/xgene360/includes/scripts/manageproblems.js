function validateDeleteProblem()
{
  xgene360_cu.using( 'form' );
  
  xgene360_cu.form.init( 'ManageProblemsForm' );
  
  xgene360_cu.form.addRequiredCheckBox( 'ProblemId[]', 'Please select at least one problem' );
  
  if ( xgene360_cu.form.validate() )
  {
    return confirm( 'Are you sure you want to delete these problems?' );
  }
  
  return false;
}

function validateDropStudent()
{
  xgene360_cu.using( 'form' );
  ...
  if ( xgene360_cu.form.validate() )
  {
    return confirm( 'Are you sure you want to drop these students?' );
  }
  
  return false;
}

function validateUpdateProblemForm()
{
  xgene360_cu.using( 'form' );
  
  xgene360_cu.form.init( 'UpdateProblemForm' );
  ...
  xgene360_cu.form.addRequiredTextBox( 'TraitAName', 'Please enter the \'First Trait Name\'', 250 );
  xgene360_cu.form.addRequiredTextBox( 'TraitBName', 'Please enter the \'Second Trait Name\'', 250 );
...
{
  return confirm( 'Updating the problem parameters will purge all generations created by students.\n\nAre you sure you want to continue?' );
}
