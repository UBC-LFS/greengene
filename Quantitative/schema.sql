...
DROP TABLE IF EXISTS `XG_Locks`;
DROP TABLE IF EXISTS `XG_Teaches`;
DROP TABLE IF EXISTS `XG_PlantParents`;
DROP TABLE IF EXISTS `XG_PlantGenerates`;
DROP TABLE IF EXISTS `XG_ProblemSolution`;
DROP TABLE IF EXISTS `XG_FeedbackLeftFor`;
DROP TABLE IF EXISTS `XG_Assists`;
DROP TABLE IF EXISTS `XG_Assigns`;
DROP TABLE IF EXISTS `XG_ProblemTraitMadeFor`;
DROP TABLE IF EXISTS `User`;
DROP TABLE IF EXISTS `Trait`;
DROP TABLE IF EXISTS `StudentProblem`;
DROP TABLE IF EXISTS `Phenotype`;
DROP TABLE IF EXISTS `MasterProblem`;
DROP TABLE IF EXISTS `LongerGeneSequences`;
...
CREATE TABLE `XG_ProblemTraitMadeFor` (
  ...
  `trait_A_histogram_range` double NOT NULL default '5',
  `trait_B_histogram_range` double NOT NULL default '5',
...
-- 
-- Table structure for table `XG_ProblemSolution`
-- 
...
-- 
-- Table structure for table `XG_PlantParents`
-- 
...
-- 
-- Table structure for table `XG_Locks`
-- 

CREATE TABLE `XG_Locks` (
  `serial_id` char(32) NOT NULL default '',
